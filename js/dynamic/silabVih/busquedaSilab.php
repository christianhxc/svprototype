...
$data = helperSilab::getMuestrasVIH($config);
//print_r($data);
$config["total"] = helperSilab::getMuestrasCantidadVIH($config);
...
$result.= '
            <tr>
                ...
                <th class="dxgvHeader_PlasticBlue" scope="">Situaci&oacute;n</th>
                ...
                foreach ($data as $data)
                {
                    ...
                    $result.='<td class="dxgv" width="5%">
                                <a title="Seleccionar" class="ui-state-default ui-corner-all ui-link-button" onmouseover="RollOver(this)" onmouseout="RollOut(this)"
                                    href="javascript:muestraSilab('.$data["id_muestra"].')"><span class="ui-icon ui-icon-check"></span></a>
                                </a>
                                </td>
