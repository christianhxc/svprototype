...
{
    if(confirm("\xbfDesea recibir todas las derivaciones del informe seleccionado?"))
        window.location = urlprefix+'analista/recibirInformeDerivaciones.php?a=t&r='+informe;
}