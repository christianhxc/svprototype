...
function buscarFormulario()
{
    ...
    $.ajax({
        type: "POST",
        url: urlprefix + 'js/dynamic/vigmor/busquedaVigmor.php',
...
function reporteIndividual(idFormulario){
    ...
    if(confirm(mensaje)){
        window.open('http://190.34.154.87:8081/jasperserver/flow.html?_flowId=viewReportFlow&reportUnit=/public/SISVIG/PRD/VIGMOR/formulario_individual&P_ID_FORMULARIO='+idFormulario+'&j_username=jasURL&j_password=jasURLMinsa&output=pdf');
    }
}