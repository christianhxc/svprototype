...
function reporteUceti(idUceti){
    ...
    if(confirm(mensaje)){
        ...
        window.location = 'http://190.34.154.87:8081/jasperserver/flow.html?_flowId=viewReportFlow&reportUnit=/public/SISVIG/PRD/VICFLU/Reporte_Individual_FLU&P_ID_FORMULARIO='+idUceti+'&j_username=jasURL&j_password=jasURLMinsa&output=pdf';
		//window.open('','_blank')
    }
}