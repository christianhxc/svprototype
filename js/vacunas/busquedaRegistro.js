...
function reporteIndividual(idForm){
    ...
    if(confirm(mensaje)){
        window.open('http://52.33.93.215:8081/jasperserver/flow.html?_flowId=viewReportFlow&reportUnit=/public/SISVIG/PRD/vacunas/vacunas_formuario_registro_diario&P_ID_FORMULARIO='+idForm+'&j_username=jasURL&j_password=jasURLMinsa&output=pdf');
    }
}
