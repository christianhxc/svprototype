<?php
require_once ('libs/pages/vacunas/reportes/reporteCoberturaPage.php');
...
$config["jsfiles"][] = "vacunas/exportableVacuna.js";
$config["jsfiles"][] = "vacunas/reportes.js";
...
//    print_r($config);
//    echo "</pre>";
$page = new reporteCoberturaPage($config);
$page->displayPage();
?>