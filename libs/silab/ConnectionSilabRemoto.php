<?php
require_once('ConfigurationSilabRemoto.php');

class ConnectionSilabRemoto{
	private $conn;
	private $dsn;
	private $stmt;
	private $error;
	...
	{
            $this->db = ($db == null) ? ConfigurationSilabRemoto::DB : $db;
            $this->dsn['username'] = ConfigurationSilabRemoto::DBuser;
	    $this->dsn['password'] = ConfigurationSilabRemoto::DBpass;
	    $this->dsn['phptype'] = ConfigurationSilabRemoto::DBHandler;
	    $this->dsn['hostspec'] = ConfigurationSilabRemoto::host;
	}
