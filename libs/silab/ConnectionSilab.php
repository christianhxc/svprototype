<?php
require_once('ConfigurationSilab.php');

class ConnectionSilab{
	private $conn;
	private $dsn;
	private $stmt;
	private $error;
	...
	{
            $this->db = ($db == null) ? ConfigurationSilab::DB : $db;
            $this->dsn['username'] = ConfigurationSilab::DBuser;
	    $this->dsn['password'] = ConfigurationSilab::DBpass;
	    $this->dsn['phptype'] = ConfigurationSilab::DBHandler;
	    $this->dsn['hostspec'] = ConfigurationSilab::host;
	}
