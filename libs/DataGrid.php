<?php
/*  * Copyright (c) 2009 Nguyen Duc Thuan <me@ndthuan.com> * All rights reserved. */
class Fete_ViewControl_DataGrid{
    ...
    /**     *     * @param array $attributes     * @return Fete_ViewControl_DataGrid     */
    ...
    /**     *     * @param string $name     * @param string $value     * @return Fete_ViewControl_DataGrid     */
    public function &setGridAttribute($name, $value)    {
        $this->_gridAttributes[$name] = $value;
        return $this;
    }
    /**     *     * @param string $field     * @param string $template     * @return Fete_ViewControl_DataGrid     */
    public function &setCellTemplate($field, $template)    {
        $this->_cellTemplates[$field] = $template;
        return $this;
    }
    /**     *     * @param string $field     * @param array $attributes     * @return Fete_ViewControl_DataGrid     */
    ...
    /**     *     * @param string $field     * @param string $name     * @param string $value     * @return Fete_ViewControl_DataGrid     */
    ...
    /**     *     * @param string $field     * @param string $header     * @return Fete_ViewControl_DataGrid     */
    public function &setHeader($field, $header)    {
        $this->_headers[$field] = $header;
        return $this;
    }
    /**     *     * @param string $columnName     * @return Fete_ViewControl_DataGrid     */
    ...
    /**     *     * @param string $columnName     * @param string $cellTemplate     * @param string $header     * @param array $attributes     * @return Fete_ViewControl_DataGrid     */
    ...
    /**     *     * @param string $cssClass     * @return Fete_ViewControl_DataGrid     */
    ...
    /**     *     * @param integer $counter     * @return Fete_ViewControl_DataGrid     */
...
//            $output .= '<form id="fdg_form_' . $this->_tableId . '" method="post" action="' . $_SERVER['REQUEST_URI'] . '"><input type="hidden" id="__sf" name="__sf" value="" /><input type="hidden" id="__so" name="__so" value="" />';
//        }
        $output .= '<table';
...
//                }
                $output .= ' id="fdg_' . $this->_tableId . '_header_' . $field . '" class="dxgvHeader_PlasticBlue"><a style="color: white" href="javascript:__ordenando(\''.$this->_headers[$field].'\')"><strong>'.(isset($this->_headers[$field]) ? $this->_headers[$field] : '') . '</strong></a></th>' .  "\n";
            }
            $output .= '</tr>' .  "\n";
        }
        if (isset($this->_datarows[0])) {
            ...
            foreach ($data as $offset => $row)            {
                ...
                $output .= '<tr class="dxgvDataRow_PlasticBlue">' . "\n";
                foreach ($this->_columns as $field)                {
