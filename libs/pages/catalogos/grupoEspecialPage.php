...
class grupoEspecialPage extends page
{
	public $config;
	...
	{
		$this->tpl->addBlockFile('CONTENT','contentBlock',Configuration::templatesPath.'/catalogos/vacGrupoEspecial.tpl.html');
                ...
                $this->tpl->setVariable("legVacGrupoEspecial", Etiquetas::legVacGrupoEspecial);
	}
}
