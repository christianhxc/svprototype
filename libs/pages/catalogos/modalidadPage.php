...
class modalidadPage extends page
{
	public $config;
	...
	{
		$this->tpl->addBlockFile('CONTENT','contentBlock',Configuration::templatesPath.'/catalogos/modalidad.tpl.html');
                ...
                $this->tpl->setVariable("legModalidad", Etiquetas::legModalidad);
	}
}
