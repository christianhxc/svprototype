...
class ldbiProveedorPage extends page
{
	public $config;
	...
	{
		$this->tpl->addBlockFile('CONTENT','contentBlock',Configuration::templatesPath.'/catalogos/ldbiproveedor.tpl.html');
                ...
                $this->tpl->setVariable("legModalidad", Etiquetas::legLdbiProvedores);
	}
}
