...
class condicionesPage extends page
{
	public $config;
	...
	{
		$this->tpl->addBlockFile('CONTENT','contentBlock',Configuration::templatesPath.'/catalogos/condiciones.tpl.html');
                ...
                $this->tpl->setVariable("legCondicion", Etiquetas::legCondicion);
	}
}
