...
class vicItsLaboratorioPage extends page {
    ...
    public function parseContent() {
        $this->tpl->addBlockFile('CONTENT', 'contentBlock', Configuration::templatesPath . 'vicits/buscarVicItsLaboratorio.tpl.html');
...
//        $this->tpl = TemplateHelp::getPaginator($this->tpl, $this->config);
        ...
        if (clsCaus::validarSeccion(ConfigurationCAUS::vicIts, ConfigurationCAUS::Consultar)) {
        ...
        if (clsCaus::validarSeccion(ConfigurationCAUS::vicIts, ConfigurationCAUS::Borrar))
            $this->tpl->setVariable("valPermisoBorrar", 'si');
        else 
            $this->tpl->setVariable("valPermisoBorrar", 'no');
        if (clsCaus::validarSeccion(ConfigurationCAUS::vicIts, ConfigurationCAUS::Reportes))
