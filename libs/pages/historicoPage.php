...
class historicoPage extends page
{
	...
	{
		$this->tpl->addBlockFile('CONTENT','contentBlock',Configuration::templatesPath.'reportes/historico.tpl.html');
			...
			foreach($entradas as $entrada)
                        {
                            $this->tpl->setCurrentBlock('blkEntradas');                            
                                ...
                                $this->tpl->touchBlock("blkHeaderReportePDF");
                                //$this->tpl->touchBlock("blkHeaderReporteXLS");

                                $this->tpl->setCurrentBlock("blkOpcionReportePDF");
                                    $this->tpl->setVariable('linkPdf',$entrada["MUE_ID"].',1');
                                $this->tpl->parse("blkOpcionReportePDF");

//                                $this->tpl->setCurrentBlock("blkOpcionReporteXLS");
//                                    $this->tpl->setVariable('linkExcel',$entrada["MUE_ID"].',2');
//                                $this->tpl->parse("blkOpcionReporteXLS");
                                ...
                                $nombreCompleto = htmlentities($entrada["IND_PRIMER_NOMBRE"].' '.$entrada["IND_SEGUNDO_NOMBRE"].' '.$entrada["IND_PRIMER_APELLIDO"].' '.$entrada["IND_SEGUNDO_APELLIDO"]);
                                $this->tpl->setVariable('nombre',(trim($nombreCompleto)==''?'No corresponde':$nombreCompleto));
                ...
                if(clsCaus::validarSeccion(ConfigurationCAUS::r5, ConfigurationCAUS::Reportes)){
