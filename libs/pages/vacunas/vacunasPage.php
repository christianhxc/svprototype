...
class vacunasPage extends page {
    ...
    public function parseContent() {
        $this->tpl->addBlockFile('CONTENT', 'contentBlock', Configuration::templatesPath . 'vacunas/buscarEsquema.tpl.html');
        ...
        if (clsCaus::validarSeccion(ConfigurationCAUS::VacFormulario, ConfigurationCAUS::Reportes))
