...
class antibioticosPage extends page
{
	public $config;
	...
	{
		$this->tpl->addBlockFile('CONTENT','contentBlock',Configuration::templatesPath.'/catalogos/antibioticos.tpl.html');
                ...
                $this->tpl->setVariable("legAntibioticos", Etiquetas::legAntibioticos);
	}
}
