...
class formLDBIReportesPage extends page {
...
//        echo "Guardar previo ".$this->config["guardarPrevio"];
        ...
        $this->tpl->addBlockFile('CONTENT', 'contentBlock', Configuration::templatesPath . 'LDBI/reportes.tpl.html');
        ...
        if (!$lectura) {
            if (clsCaus::validarSeccion(ConfigurationCAUS::influenza, ConfigurationCAUS::Agregar)) {
                $this->tpl->setVariable("botonGuardar", '<a href="javascript:generar();" class="ui-state-default ui-corner-all ui-button" onmouseover="RollOver(this)" onmouseout="RollOut(this)">Generar</a>&nbsp;');
