...
class formLDBIEnvioPdfPage extends page {
...
//        echo "Guardar previo ".$this->config["guardarPrevio"];
        ...
        $this->tpl->addBlockFile('CONTENT', 'contentBlock', Configuration::templatesPath . 'LDBI/pdf/envio.tpl.html');
        ...
        if ($this->config['data']){
            $this->tpl->setVariable('valEnvioId', $this->config['data']["requesicion"]['id_envio']);
            $this->tpl->setVariable('valEnvioNoEnvio', $this->config['data']["requesicion"]['no_envio']);
            ...
            $this->tpl->setVariable('valEnvioFechaEnvio', helperString::toDateView($this->config['data']["requesicion"]['fh_envio']));
            ...
            $this->tpl->setVariable('valNotificacionRegionOrigen', $this->config['data']["requesicion"]['nombre_region_origen']);
            $this->tpl->setVariable('valNotificacionRegionDestino', $this->config['data']["requesicion"]['nombre_region_destino']);

            $this->tpl->setVariable('valRequesicionEstatus', $this->obtenerEstado($this->config['data']["requesicion"]['status']));
        } else {
            $documento = "E".date("ymdhis");
