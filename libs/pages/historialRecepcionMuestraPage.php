...
class historialRecepcionMuestraPage extends page
{
	public $config;
	...
	{
		$this->tpl->addBlockFile('CONTENT','contentBlock',Configuration::templatesPath.'analista/historialMuestras.tpl.html');
                            ...
                            $this->tpl->setCurrentBlock('blkEntradas');
                                ...
                                $this->tpl->setCurrentBlock("blkRecibirTodas");
                                    if($entrada["INF_ENV_RESTANTES"]>0)
                                        $this->tpl->setVariable('linkRecibirTodas','<a href="javascript:recibirTodas('.$entrada["id"].')" onmouseout="RollOut(this)" onmouseover="RollOver(this)" class="ui-state-default ui-corner-all ui-link-button" title="Recibir todas las muestras de este informe">
...
//                                $this->tpl->parse("blkRecibirSelectivo");
                ...
                if(clsCaus::validarSeccion(ConfigurationCAUS::a1, ConfigurationCAUS::Consultar))
                {
