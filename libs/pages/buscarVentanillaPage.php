...
class buscarVentanillaPage extends page
{
	public $config;
	...
	{
		$this->tpl->addBlockFile('CONTENT','contentBlock',Configuration::templatesPath.'ventanilla/buscarMuestra.tpl.html');
		...
		$entradas = $this->config["entradas"];
                if(is_array($entradas))
                {
                        foreach($entradas as $entrada)
                        {
                            $this->tpl->setCurrentBlock('blkEntradas');
                                ...
                                if(!clsCaus::validarSeccion(ConfigurationCAUS::v3, ConfigurationCAUS::Modificar))
                                ...
                                if($entrada["ubicacion"]==Configuration::ventanilla)
                                {
                                    if($entrada["tipo"]==Configuration::tipoMuestra)
                                        ...
                                        '<a href="asignarAlicuota.php?m='.$entrada["MUE_ID"].'" onmouseout="RollOut(this)" onmouseover="RollOver(this)" class="ui-state-default ui-corner-all ui-link-button" title="Asignar al&iacute;cuotas">'
                                ...
                                if($entrada["ubicacion"]==Configuration::ventanilla)
                                        ...
                                        '<a href="javascript:confirmarAnular('.$entrada["MUE_ID"].');" onmouseout="RollOut(this)" onmouseover="RollOver(this)" class="ui-state-default ui-corner-all ui-link-button" title="Anular" >'
                ...
                if(clsCaus::validarSeccion(ConfigurationCAUS::v3, ConfigurationCAUS::Consultar)){
