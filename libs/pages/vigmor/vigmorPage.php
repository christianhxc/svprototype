...
class vigmorPage extends page {
    ...
    public function parseContent() {
        $this->tpl->addBlockFile('CONTENT', 'contentBlock', Configuration::templatesPath . 'vigmor/buscarVigmor.tpl.html');
        ...
        if (clsCaus::validarSeccion(ConfigurationCAUS::vigmorFormulario, ConfigurationCAUS::Borrar))
