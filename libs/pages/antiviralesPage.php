...
class antiviralesPage extends page
{
	public $config;
	...
	{
		$this->tpl->addBlockFile('CONTENT','contentBlock',Configuration::templatesPath.'/catalogos/antivirales.tpl.html');
                ...
                $this->tpl->setVariable("legAntivirales", Etiquetas::legAntivirales);
	}
}
