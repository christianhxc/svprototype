...
class historialPage extends page
{
	public $config;
	...
	{
		$this->tpl->addBlockFile('CONTENT','contentBlock',Configuration::templatesPath.'ventanilla/historial.tpl.html');
		...
		if(is_array($entradas))
			...
			foreach($entradas as $entrada)
                ...
                if(clsCaus::validarSeccion(ConfigurationCAUS::v5, ConfigurationCAUS::Consultar))
                {
