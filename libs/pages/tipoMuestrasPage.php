...
class tipoMuestrasPage extends page
{
	public $config;
	...
	{
		$this->tpl->addBlockFile('CONTENT','contentBlock',Configuration::templatesPath.'/catalogos/tipoMuestras.tpl.html');
                ...
                $this->tpl->setVariable("legTipoMuestras", Etiquetas::legTipoMuestras);
	}
}
