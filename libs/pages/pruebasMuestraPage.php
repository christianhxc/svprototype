...
class pruebasMuestraPage extends page
{
	public $config;
	...
	{
		$this->tpl->addBlockFile('CONTENT','contentBlock',Configuration::templatesPath.'analista/pruebasMuestra.tpl.html');
...
//                                $this->tpl->setVariable('idPrueba','pr'.$entrada["ANA_MUE_ID"]);
                ...
                $this->tpl->setVariable('valIdentificador',$this->config["data"]["IND_HISTORIA_CLINICA"]);
                $this->tpl->setVariable('valEdad',$this->config["data"]["IND_EDAD"]);
