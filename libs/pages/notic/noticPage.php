...
class noticPage extends page {
    ...
    public function parseContent() {
        $this->tpl->addBlockFile('CONTENT', 'contentBlock', Configuration::templatesPath . 'notic/buscarNotic.tpl.html');
        ...
        if (clsCaus::validarSeccion(ConfigurationCAUS::noticFormulario, ConfigurationCAUS::Borrar))
            $this->tpl->setVariable("valPermisoBorrar", 'si');
        else 
            $this->tpl->setVariable("valPermisoBorrar", 'no');
        
        if (clsCaus::validarSeccion(ConfigurationCAUS::noticReporteIndividual, ConfigurationCAUS::Consultar))
