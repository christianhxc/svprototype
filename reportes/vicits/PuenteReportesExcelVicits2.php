<?php
    ...
    if ($_REQUEST['s'] == "F") 
        $report = $compileManager->compileReport(realpath("exportacion_excel_mujer2.jrxml"));
//    if ($_REQUEST['s'] == "M") 
...
//        $report = $compileManager->compileReport(realpath("reporte_individal_fem.jrxml"));
    ...
    header("Content-Disposition: attachment; filename=exportable_excel_".date('d-m-Y').".xls");
