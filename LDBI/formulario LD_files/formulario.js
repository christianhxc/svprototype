...
function relacionarMuestraUceti(){
    ...
    var nombreTipoMuestra = $("#drpTipoMuestras").find(":selected").text();
...
function crearTablaMuestrasUceti(){
    ...
    for(var i=0; i<globalMuestrasUceti.length;i++){
        if(__isset(globalMuestrasUceti[i])){
            ...
            tabla += '<tr>'+
            '<td class="fila" width="250px" >'+globalMuestrasUceti[i][1]+'</th>'+
            '<td class="fila" width="60px" style="text-align:center">'+globalMuestrasUceti[i][2]+'</th>'+
            '<td class="fila" width="60px" style="text-align:center">'+globalMuestrasUceti[i][3]+'</th>'+
            '<td class="fila" width="60px" style="text-align:center">'+globalMuestrasUceti[i][4]+'</th>'+
            '<td class="fila" width="40px" style="text-align:center">'+diasEvolucion+'</th>'+
            '<td class="fila" width="40px" style="text-align:center">'+diasRecibido+'</th>'+
            '<td class="fila" width="40px" align="center"><a href="javascript:eliminarRelMuestraUceti('+i+')"><img src="'+urlprefix+'/img/Delete.png" title="Eliminar" border="0"/></a></th>'+
            '<tr>';
        }
    }
    tabla += "</table>";
