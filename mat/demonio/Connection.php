...
class Connection{
	...
	{
            $this->db = ($db == null) ? Configuration::DB : $db;
            $this->dsn['username'] = Configuration::DBuser;
	    $this->dsn['password'] = Configuration::DBpass;
	    $this->dsn['phptype'] = Configuration::DBHandler;
	    $this->dsn['hostspec'] = Configuration::host;
	}
